...
- `DECISION`: `APPROVAL_REQUESTED`, `APPROVAL_REJECTED`
...
Inbox 화면은 `DECISION`, `DISCUSSION`, `AWARENESS`, `RESULT` 탭으로 구성됩니다. `/api/bootstrap`도 현재 사용자에게 관련된 Inbox를 포함합니다.
